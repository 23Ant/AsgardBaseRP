					...
					for l,w in pairs(policia) do
						...
						if player then
							async(function()
								...
								--TriggerClientEvent('chatMessage',-1,"COPOM",{245,0,0},"O roubo começou na ^1Caixa Registradora^0, dirija-se até o local e intercepte o assaltante.")
								TriggerClientEvent('chatMessage',player,"COPOM",{245,0,0},"O roubo começou na ^1Caixa Registradora^0, dirija-se até o local e intercepte o assaltante.")
