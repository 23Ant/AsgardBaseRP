...
local webhooklink1 = "https://discordapp.com/api/webhooks/710269564256124969/P_knc1wJ9R2-ANDPvrqNI5jE09m5nItzhNZiWTksmPqPB6TYgAtRH6NL-FhT-GEEMUNk"
...
AddEventHandler("vRP:playerJoin",function(user_id,source,name)
	vRP.execute("vRP/money_init_user",{ user_id = user_id, wallet = 2000, bank = 23000 })
	local tmp = vRP.getUserTmpTable(user_id)
	if tmp then
