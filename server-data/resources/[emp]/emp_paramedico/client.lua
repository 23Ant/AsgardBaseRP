...
local CoordenadaX = 311.39346313477
local CoordenadaY = -594.5515747070
local CoordenadaZ = 43.283988952637
...
Citizen.CreateThread(function()
	while true do
		...
		if emservico then
			...
			if IsControlJustPressed(0,168) and IsVehicleModel(vehicle,GetHashKey("sprintersamu")) then
				RemoveBlip(blips)
				if DoesEntityExist(passageiro) then
					TaskLeaveVehicle(passageiro,vehicle,262144)
					TaskWanderStandard(passageiro,10.0,10)
